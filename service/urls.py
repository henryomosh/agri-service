...
urlpatterns = [
    ...
    path('market/search-product/', views.search, name='search'),
    ...
    path('profile/user-product-details/<int:product_id>/', views.user_product_details, name='user_product_details'),
    path('profile/user-product-edit/<int:product_id>/', views.edit_user_product, name='edit_product'),
    path('profile/user-product-delete/<int:product_id>/', views.delete_product, name='delete_product'),
    path('article/article-details/<int:article_id>/', views.article_details, name='article details'),
